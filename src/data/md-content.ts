    ...
    "faq": {
      "items": [
        ...
        },
        {
          ...
          "answer": "Email us at app@odomate.net with:\n- Description of the bug\n- Steps to reproduce\n- Screenshots (if possible)\n- Device and OS information"
        },
        {
          "question": "How do I request a feature?",
          "answer": "We love feedback! Email app@odomate.net with your feature request."
        },
        {
        ...
        },
        {
          ...
          "answer": "Refunds are handled by Google Play or App Store per their policies. Contact app@odomate.net within 48 hours of purchase for consideration.\n---\n**Website:** odomate.net  \n**Email:** app@odomate.net  \n**Privacy Policy:** [View Policy](PRIVACY_POLICY_EN.md)  \n**Terms of Service:** [View Terms](TERMS_OF_SERVICE_EN.md)\n---\n**Didn't find your question? Contact app@odomate.net**"
        }
      ]
    },
    "privacy": {
    ...
    "faq": {
      "items": [
        ...
        },
        {
          ...
          "answer": "Напишите нам на app@odomate.net с указанием:\n- Описания ошибки\n- Шагов для воспроизведения\n- Скриншотов (если возможно)\n- Информации об устройстве и ОС"
        },
        {
          "question": "Как запросить новую функцию?",
          "answer": "Мы любим обратную связь! Напишите на app@odomate.net с вашим предложением."
        },
        {
        ...
        },
        {
          ...
          "answer": "Возвраты средств обрабатываются Google Play или App Store в соответствии с их политикой. Свяжитесь с app@odomate.net в течение 48 часов после покупки для рассмотрения.\n---\n**Сайт:** odomate.net  \n**Email:** app@odomate.net  \n**Политика конфиденциальности:** [Просмотреть](PRIVACY_POLICY_RU.md)  \n**Условия использования:** [Просмотреть](TERMS_OF_SERVICE_RU.md)\n---\n**Не нашли ответ на свой вопрос? Свяжитесь с app@odomate.net**"
        }
      ]
    },
    "privacy": {
    ...
    "faq": {
      "items": [
        ...
        },
        {
          ...
          "answer": "Напишіть нам на app@odomate.net із зазначенням:\n- Опису помилки\n- Кроків для відтворення\n- Скріншотів (якщо можливо)\n- Інформації про пристрій та ОС"
        },
        {
          "question": "Як запитати нову функцію?",
          "answer": "Ми любимо зворотний зв'язок! Напишіть на app@odomate.net з вашою пропозицією."
        },
        {
        ...
        },
        {
          ...
          "answer": "Повернення коштів обробляються Google Play або App Store відповідно до їх політики. Зв'яжіться з app@odomate.net протягом 48 годин після покупки для розгляду.\n---\n**Сайт:** odomate.net  \n**Email:** app@odomate.net  \n**Політика конфіденційності:** [Переглянути](PRIVACY_POLICY_UK.md)  \n**Умови використання:** [Переглянути](TERMS_OF_SERVICE_UK.md)\n---\n**Не знайшли відповідь на своє запитання? Зв'яжіться з app@odomate.net**"
        }
      ]
    },
    "privacy": {
    ...
    "faq": {
      "items": [
        ...
        },
        {
          ...
          "answer": "Envoyez-nous un email à app@odomate.net avec :\n- Description du bug\n- Étapes pour le reproduire\n- Captures d'écran (si possible)\n- Informations sur l'appareil et l'OS"
        },
        {
          "question": "Comment demander une fonctionnalité ?",
          "answer": "Nous adorons les retours ! Envoyez un email à app@odomate.net avec votre demande."
        },
        {
        ...
        },
        {
          ...
          "answer": "Les remboursements sont gérés par Google Play ou App Store selon leurs politiques. Contactez app@odomate.net dans les 48 heures suivant l'achat pour examen.\n---\n**Site web :** odomate.net  \n**Email :** app@odomate.net  \n**Politique de confidentialité :** [Voir](PRIVACY_POLICY_FR.md)  \n**Conditions d'utilisation :** [Voir](TERMS_OF_SERVICE_FR.md)\n---\n**Vous n'avez pas trouvé votre question ? Contactez app@odomate.net**"
        }
      ]
    },
    "privacy": {
      "content": [
        ...
        {
          "heading": "Contact",
          "text": "app@odomate.net | odomate.net | Oleksandr Konovalov"
        }
      ]
    },
    "terms": {
    ...
    "faq": {
      "items": [
        ...
        },
        {
          ...
          "answer": "Schreiben Sie uns an app@odomate.net mit:\n- Beschreibung des Fehlers\n- Schritte zur Reproduktion\n- Screenshots (falls möglich)\n- Geräte- und OS-Informationen"
        },
        {
          "question": "Wie kann ich eine Funktion vorschlagen?",
          "answer": "Wir lieben Feedback! Schreiben Sie an app@odomate.net mit Ihrem Vorschlag."
        },
        {
        ...
        },
        {
          ...
          "answer": "Rückerstattungen werden von Google Play oder App Store gemäß deren Richtlinien bearbeitet. Kontaktieren Sie app@odomate.net innerhalb von 48 Stunden nach dem Kauf zur Prüfung.\n---\n**Website:** odomate.net  \n**E-Mail:** app@odomate.net  \n**Datenschutzrichtlinie:** [Ansehen](PRIVACY_POLICY_DE.md)  \n**Nutzungsbedingungen:** [Ansehen](TERMS_OF_SERVICE_DE.md)\n---\n**Ihre Frage nicht gefunden? Kontaktieren Sie app@odomate.net**"
        }
      ]
    },
    "privacy": {
    ...
    "faq": {
      "items": [
        ...
        },
        {
          ...
          "answer": "Wyślij nam email na app@odomate.net z:\n- Opisem błędu\n- Krokami do odtworzenia\n- Zrzutami ekranu (jeśli możliwe)\n- Informacjami o urządzeniu i OS"
        },
        {
          "question": "Jak poprosić o funkcję?",
          "answer": "Uwielbiamy opinie! Wyślij email na app@odomate.net z twoją prośbą."
        },
        {
        ...
        },
        {
          ...
          "answer": "Zwroty są obsługiwane przez Google Play lub App Store zgodnie z ich politykami. Skontaktuj się z app@odomate.net w ciągu 48 godzin od zakupu w celu rozpatrzenia.\n---\n**Strona internetowa:** odomate.net  \n**Email:** app@odomate.net  \n**Polityka prywatności:** [Zobacz](PRIVACY_POLICY_PL.md)  \n**Regulamin:** [Zobacz](TERMS_OF_SERVICE_PL.md)\n---\n**Nie znalazłeś swojego pytania? Skontaktuj się z app@odomate.net**"
        }
      ]
    },
    "privacy": {
    ...
    "faq": {
      "items": [
        ...
        },
        {
          ...
          "answer": "Envíanos un correo electrónico a app@odomate.net con:\n- Descripción del error\n- Pasos para reproducir\n- Capturas de pantalla (si es posible)\n- Información del dispositivo y SO"
        },
        {
          "question": "¿Cómo solicito una función?",
          "answer": "¡Nos encanta recibir comentarios! Envía un correo electrónico a app@odomate.net con tu solicitud."
        },
        {
        ...
        },
        {
          ...
          "answer": "Los reembolsos son manejados por Google Play o App Store según sus políticas. Contacta a app@odomate.net dentro de las 48 horas posteriores a la compra para consideración.\n---\n**Sitio web:** odomate.net  \n**Email:** app@odomate.net  \n**Política de privacidad:** [Ver política](PRIVACY_POLICY_ES.md)  \n**Términos de servicio:** [Ver términos](TERMS_OF_SERVICE_ES.md)\n---\n**¿No encontraste tu pregunta? Contacta a app@odomate.net**"
        }
      ]
    },
    "privacy": {
